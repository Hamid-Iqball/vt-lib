...
const CustomSelect = (props) => {
  ...
  const customStyles = {
    ...
    const baseStyles = {
        ...
        boxShadow: 'none',
        outline: 'none',
        border: '1px solid #9e9e9e', // Remove all other borders
        // border: state.isFocused ? '1px solid #3da5f4' : '1px solid #9e9e9e', // Blue bottom border on focus
        borderRadius: 5, // Remove border-radius to make it look like a line
        color: '#495057',
